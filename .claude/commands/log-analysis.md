...
KAE-49 (the maintainer's iMessage 2026-04-28).

**Setup — SSH to the VM and locate the repo:**
```bash
ssh user@vm.example.com "cd /home/user/projects/kaetram-agent && pwd"
```
...
## Step 2 — paper metrics (the maintainer's 5)
...
- the maintainer's metrics proposal: iMessage 2026-04-28 (format / argument / tool-selection
