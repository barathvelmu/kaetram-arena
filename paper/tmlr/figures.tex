...
\begin{tikzpicture}[
  ...
  \node[box,minimum width=2.6cm,fill=routeorange!10] (content) at (4.0,-0.65)
    {ordinary content};
  ...
  \node[routeorange,align=center,anchor=north] at (4.0,-1.05)
    {a valid-looking call can be stranded here};
