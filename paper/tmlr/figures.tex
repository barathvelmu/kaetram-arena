...
\begin{tikzpicture}[
  ...
  \node[box,minimum width=2.3cm,draw=routeorange!80,dashed] (parser) at (7.1,-0.65) {recovery parser};
  ...
  \draw[line,routeorange,dashed] (parser.east) -- (candidate.west);
  ...
  \node[routeorange,align=center,anchor=north,font=\sffamily\scriptsize] at (4.0,-1.42)
    {all \SpanInsideReasoning{}/\SpanRecoveredCalls{} recovered calls sat in the\\reasoning field, which the backend does not route};
...
\begin{tikzpicture}[font=\sffamily\scriptsize]
  ...
  \begin{axis}[
    ...
    width=7.4cm,height=4.35cm,
    title style={font=\sffamily\bfseries\small,align=center,yshift=3.2ex},
    title={(b) Post-hoc valid candidate\\either route (pools an unexecutable one)},
    xmin=0,xmax=40,xtick={0,10,20,30,40},
    xlabel={schema-present $-$ schema-absent (pp)},
    ytick={1,2,3},yticklabels={Round 3,Round 2,Base},
    grid=major,grid style={routegray!18},axis line style={routegray!65},
