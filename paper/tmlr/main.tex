...
strict content recovery, and a recovery-off control. All nine trials were
protocol-valid; the sealed verdict was \texttt{complete\_with\_failures}.
Structured input and content recovery each passed all three technical repeats:
exactly one candidate was delivered, the application
