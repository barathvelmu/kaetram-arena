...
bridge. Across 1,020 new pilot-unseen requests, the registered thinking-off
minus retained thinking-on contrasts were $-28.2$, $-22.1$, and $-28.8$ points
for body-only incidence and $+58.8$, $+58.8$, and $+60.0$ points for structured
incidence. In paired classification, the 269 thinking-on body-only cells aligned
with 248 structured and 21 no-candidate thinking-off responses. The registered
all-three-checkpoint criterion passed.
