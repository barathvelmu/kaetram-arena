...
student rollouts with hand-selected, verified intermediate player states. Evaluated from a fresh,
...
rollouts from verified intermediate database states; the confirmatory protocol
...
some student rollouts begin from verified intermediate player states, and
...
sufficient. Evaluation is always
unseeded. This resembles reset-based curricula in reinforcement learning
...
The independent unit is a six-hour run from a fresh canonical unseeded world. The
