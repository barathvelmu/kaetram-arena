...
## Recent Major Changes (Apr 24 – May 14, 2026)
...
- **Data scale milestone (May 3, updated May 14).** Post-archive-split active corpus: 34 runs / 2,018 sessions across 3 agents (agent_0: 14/571, agent_1: 10/728, agent_2: 10/719). Includes both Claude collection runs and Qwen eval runs (qwen-base 3h run `run_20260510_173852` + longer runs `run_20260510_211339`, `run_20260512_120516`). 1,694 non-active sessions archived under `dataset/raw/_archive/` (1,049 Claude + 645 non-Claude). r10 dataset uses 5 source runs / 135 sessions from the active Claude pool. Rick's Roll stage-2+ prompt knowledge shipped May 1 (`154badc`).
