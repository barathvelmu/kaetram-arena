...
Compiled knowledge for the this research project. Two independent papers: Paper 1 (Kaetram distillation, ICLR 2027) and Paper 2 (RuneScape adversarial multi-agent, planned). See `research/decisions/acquihire-trajectory.md` for company scope and competitive analysis.
...
- [acquihire-trajectory.md](decisions/acquihire-trajectory.md) — Workshop Labs → Thinking Machines precedent, Kaetram Arena competitive analysis, visibility gaps, critical path to paper
