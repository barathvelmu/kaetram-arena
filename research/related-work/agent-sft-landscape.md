...
**Our relevance:** Our r10 dataset (9,363 records) is ~18x above the emergence threshold. Fine-tuning will make Qwen 3.5 9B more robust than prompting for the noisy game environment.
...
- Data: proprietary Tencent production replays (undisclosed scale) vs. our fully open 9,363 records (r10)
...
1. **500 trajectories is the floor, 6k is the sweet spot** — r10 sits at 9,363 records (135 sessions, post-Core-3 Claude only, after thinking-ratio + truncation gates); above the LoRA floor and within the multi-turn-tool-use sweet spot
