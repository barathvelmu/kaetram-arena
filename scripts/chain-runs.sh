...
PROJECT=/home/user/projects/kaetram-agent
KAETRAM=/home/user/projects/Kaetram-Open
LOG=/tmp/chainer.log
RUNS=${1:-3}
...
python3 - <<'PY' >> "$LOG" 2>&1
import json, pathlib
p = pathlib.Path('/home/user/projects/Kaetram-Open/packages/server/data/tables.json')
