...
def cmd_metrics(views: list[tuple[Path, SessionView]]) -> None:
    """v1 paper metrics — the maintainer's 5 metrics from 2026-04-28 iMessage.
    ...
    for agent_dir, sv in views:
        ...
        # v1 = quest count out of 5. the maintainer's "/11" framing wants stages summed
    ...
    print()
    print("v1 caveats (the maintainer, refine as needed):")
    ...
    print()
    print("Source: the maintainer's iMessage 2026-04-28 — format / argument / tool-selection /")
